...
*/
SceneCmd mytest_scene_header00[] = {
    SCENE_CMD_COL_HEADER(&mytest_scene_collisionHeader),
    SCENE_CMD_ROOM_LIST(1, mytest_scene_roomList),
    ...
    SCENE_CMD_ENV_LIGHT_SETTINGS(4, mytest_scene_header00_lightSettings),
    SCENE_CMD_SPAWN_LIST(mytest_scene_header00_entranceList),
    SCENE_CMD_PLAYER_ENTRY_LIST(1, mytest_scene_header00_playerEntryList),
    SCENE_CMD_END(),
};

RomFile mytest_scene_roomList[] = {
    { (uintptr_t)_mytest_room_0SegmentRomStart, (uintptr_t)_mytest_room_0SegmentRomEnd },
};

ActorEntry mytest_scene_header00_playerEntryList[] = {
    // Link / Spawn point
    {
...
Spawn mytest_scene_header00_entranceList[] = {
    // { Spawn Actor List Index, Room Index }
    { 0, 0 },
};

EnvLightSettings mytest_scene_header00_lightSettings[4] = {
...
CollisionPoly mytest_scene_polygons[2] = {
...
CollisionHeader mytest_scene_collisionHeader = {
    { -300, -120, -300 },
    { 300, -120, 300 },
    ARRAY_COUNT(mytest_scene_vertices), mytest_scene_vertices,
    ARRAY_COUNT(mytest_scene_polygons), mytest_scene_polygons,
    mytest_scene_polygonTypes,
    NULL,
    0, NULL
};
