...
*/
SceneCmd papermario_scene_header00[] = {
    SCENE_CMD_COL_HEADER(&papermario_scene_collisionHeader),
    SCENE_CMD_ROOM_LIST(1, papermario_scene_roomList),
    ...
    SCENE_CMD_ENV_LIGHT_SETTINGS(4, papermario_scene_header00_lightSettings),
    SCENE_CMD_SPAWN_LIST(papermario_scene_header00_entranceList),
    SCENE_CMD_PLAYER_ENTRY_LIST(1, papermario_scene_header00_playerEntryList),
    SCENE_CMD_END(),
};

RomFile papermario_scene_roomList[] = {
    { (uintptr_t)_papermario_room_0SegmentRomStart, (uintptr_t)_papermario_room_0SegmentRomEnd },
};

ActorEntry papermario_scene_header00_playerEntryList[] = {
    // Link / Spawn point
    {
...
Spawn papermario_scene_header00_entranceList[] = {
    // { Spawn Actor List Index, Room Index }
    { 0, 0 },
};

EnvLightSettings papermario_scene_header00_lightSettings[4] = {
...
SurfaceType papermario_scene_polygonTypes[1] = {
    { SURFACETYPE0(0, 0, 0x00, 0, 0x00, 0x00, 0, 0), SURFACETYPE1(0x00, 0x00, 0, 0, 0, 0, 0, 0) },
};

Vec3s papermario_scene_vertices[4] = {
    {   -300,   -120,    300 },
    {    300,   -120,    300 },
    {    300,   -120,   -300 },
    {   -300,   -120,   -300 },
...
CollisionPoly papermario_scene_polygons[2] = {
...
CollisionHeader papermario_scene_collisionHeader = {
    { -300, -120, -300 },
    { 300, -120, 300 },
    ARRAY_COUNT(papermario_scene_vertices), papermario_scene_vertices,
    ARRAY_COUNT(papermario_scene_polygons), papermario_scene_polygons,
    papermario_scene_polygonTypes,
    NULL,
    0, NULL
};
