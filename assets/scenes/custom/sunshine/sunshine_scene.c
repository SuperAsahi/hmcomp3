...
*/
SceneCmd sunshine_scene_header00[] = {
    SCENE_CMD_COL_HEADER(&sunshine_scene_collisionHeader),
    SCENE_CMD_ROOM_LIST(1, sunshine_scene_roomList),
    ...
    SCENE_CMD_ENV_LIGHT_SETTINGS(4, sunshine_scene_header00_lightSettings),
    SCENE_CMD_SPAWN_LIST(sunshine_scene_header00_entranceList),
    SCENE_CMD_PLAYER_ENTRY_LIST(1, sunshine_scene_header00_playerEntryList),
    SCENE_CMD_END(),
};

RomFile sunshine_scene_roomList[] = {
    { (uintptr_t)_sunshine_room_0SegmentRomStart, (uintptr_t)_sunshine_room_0SegmentRomEnd },
};

ActorEntry sunshine_scene_header00_playerEntryList[] = {
    // Link / Spawn point
    {
...
Spawn sunshine_scene_header00_entranceList[] = {
    // { Spawn Actor List Index, Room Index }
    { 0, 0 },
};

EnvLightSettings sunshine_scene_header00_lightSettings[4] = {
...
SurfaceType sunshine_scene_polygonTypes[1] = {
    { SURFACETYPE0(0, 0, 0x00, 0, 0x00, 0x00, 0, 0), SURFACETYPE1(0x00, 0x00, 0, 0, 0, 0, 0, 0) },
};

Vec3s sunshine_scene_vertices[4] = {
    {   -300,   -120,    300 },
    {    300,   -120,    300 },
    {    300,   -120,   -300 },
    {   -300,   -120,   -300 },
...
CollisionPoly sunshine_scene_polygons[2] = {
...
CollisionHeader sunshine_scene_collisionHeader = {
    { -300, -120, -300 },
    { 300, -120, 300 },
    ARRAY_COUNT(sunshine_scene_vertices), sunshine_scene_vertices,
    ARRAY_COUNT(sunshine_scene_polygons), sunshine_scene_polygons,
    sunshine_scene_polygonTypes,
    NULL,
    0, NULL
};
